...
const RestaurantDetails = () => {
  ...
  useEffect(() => {
    const fetchRestaurant = async () => {
      try {
        const response = await fetch(`https://dsp-1.onrender.com/restaurants/${id}`);
        ...
        <div>
          ...
          {restaurant.url && (
            <a
              ...
              className="mt-6 inline-block bg-beige-600 text-white px-6 py-3 rounded-lg hover:bg-balck-700 transition text-center"
            >
              Visit Website
            </a>
          )}
