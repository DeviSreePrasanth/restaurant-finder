  ...
  useEffect(() => {
    ...
    const fetchRestaurants = async () => {
      ...
      try {
        ...
        const response = await fetch("https://webapp-satyatej10-main.onrender.com/restaurants/image-search", {
          method: "POST",
          body: formData,
        });
  ...
  return (
    <>
      ...
      <div className="container mx-auto p-8 pt-16 bg-gradient-to-r from-slate-100 via-gray-200 to-stone-300 min-h-screen">
        <h2 className="text-3xl font-bold text-gray-800 text-center mb-6 mt-5">Image-Based Restaurant Search</h2>
